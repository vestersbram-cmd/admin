---
name: notebooklm
description: Complete programmatic API for Google NotebookLM. Create notebooks, add sources (URLs, PDFs, YouTube, audio), generate all artifact types (podcasts, videos, reports, quizzes), and download results in multiple formats.
---
